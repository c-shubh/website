...
const projects: Project[] = [
	...
	},
	{
		...
		builtWith: [t.chakarui, t.nextjs, t.tailwindcss, t.typescript, t.expressjs, t.mongodb],
...

	{
		...
		description: 'Lists HackerNews posts using its [API](https://github.com/HackerNews/API).',
	...
	{
		title: 'Advice',
		description: 'Receive unlimited unsolicited advice in this beautifully designed web page.',
		builtWith: [t.html, t.css, t.javascript],
	...
	{
		title: 'Calculator',
		description: 'A calculator. Design inspired by the Windows 10 calculator program.',
		builtWith: [t.html, t.css, t.javascript],
	...
	},
	{
		...
		builtWith: [t.reactjs, t.fusejs, t.typescript, t.nodejs, t.expressjs, t.mongodb],
		startDate: '2023-03-04',
		// hide liveUrl for now since render backend keeps crashing
		// liveUrl: "https://c-shubh.github.io/fullstackopen/phonebook/",
		srcUrl: 'https://github.com/c-shubh/fullstackopen/tree/main/part2/phonebook'
	},
	...
	{
		title: 'Text to ASCII',
		description: 'A CLI program to create ASCII text banners. Supports multiple fonts.',
		builtWith: [t.python],
