...
export const tools = [
	...
	{ name: 'Instant Post', slug: 'instant-post', description: 'Draft text and cross-post to X, Mastodon, or Bluesky.'},
	...
	{ name: 'Word Count', slug: 'word-count', description: 'Count characters, words, and lines in text.' },
] as const;
