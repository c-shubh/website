// https://github.com/batman-nair/puddle.js + some of my own modifications
...
class Puddle {
  constructor(element, updateInterval = 100) {
  ...
  setNodeSize(nodeSize) {
    ...
    if (this.elementHeight) {
      this.numRows = Math.ceil(this.elementHeight / this.nodeSize);
      this.numCols = Math.ceil(this.elementWidth / this.nodeSize);
    }
    this.setupGrid();
  }
