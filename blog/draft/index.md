...
Under the heavy motivation of new year, thinking to myself, that I'd write more posts throughout the year, I wrote a post on [1st of January 2025](/blog/extracting-discords-welcome-messages).
...
Checking the git history, I'd made made only small cosmetic changes, and improvements / fixes to [tools](/tools) until August 2025.
Then in the next couple of months, I succumbed, and set on to rewrite this website.
After partial rewrites with Astro, Next.js and Svelte, I settled on Astro, and modified its blog starter kit to my liking.
Along the way, I lost about 4-5 draft blog posts which were stashed / committed locally, but not pushed to remote.
One thing I'm proud of after this rewrite is that, I've made sure to not break any URL, because [cool URIs don't change](https://www.w3.org/Provider/Style/URI).
...
I liked it and was exploring around the website, where I found a link to [100 Days To Offload](https://100daystooffload.com/) in the footer.
...
The thought of blogging feels enticing but it is the act that fails.
...
Reflecting on my relationship with my phone, it's turned into a procrastination and attention span killing machine, which is not what I want to use my phone for.
This challenge is an attempt to fix that, reduce my screen time, and reflect about it every week.

Here's the screen time stats for 2026-W09 week:

![Monday: 5.30 hrs, Tuesday: 5.04 hrs, Wednesday: 3.88 hrs, Thursday: 4.43 hrs, Friday: 5.23 hrs, Saturday: 6.42 hrs and Sunday: 4.06 hrs](2026-W09-screen-time.png)

## In the end

I've decided to publish changes to the website only on weekends, and include the changes in the weekly notes.
This way, even if I have nothing interesting to write about (which is a rare happening :p), I can just write about the changes I make to the website.

Today is Monday, March 2, 2025.
...
What I think I'd gain from this:

- Fun writing and sharing things
- Improved writing
- Reduced phone screen time
- Making some internet friends? I've seen many people get introduced to each other through the indie web. Let's see how it goes.
